            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-5">
              ...
              <div className="flex-1 flex-col">
                <div className="relative">
                  <i className="fa-solid fa-map absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"></i>
                  <select
                    value={selectedState}
                    onChange={(e) => {
              ...
              <div className="flex-1 flex-col">
                <div className="relative">
                  <i className="fa-solid fa-city absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"></i>
                  <select
                    value={district}
                    onChange={(e) => {
